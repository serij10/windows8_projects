...
namespace photoPuzzle
{
    ...
    class PuzzleGame
    {
        public int colsAndRows;
        private int[] board;
        private int totalMoves;
        private bool isPlaying;
        public TextBlock Congratulations;
        ...
        public PuzzleGame(int colsAndRows, TextBlock Congratulations)
        {
            if (colsAndRows < 2)
            {
        ...
        public bool MovePiece(int pieceId)
        {
                ...
                (boardLoc == emptyLoc - ColsAndRows))
            {
                ...
                this.CheckWinner(Congratulations);
                return true;
            }
        ...
        public void CheckWinner(TextBlock Congratulations)
        {
            bool completed = true;
            int totalPieces = colsAndRows * colsAndRows;
            for (int n = 0; n < totalPieces - 1; n++)
